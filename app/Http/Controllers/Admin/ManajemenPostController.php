...
class ManajemenPostController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $posts = Post::where('author', $user->id)->when($keyword, function ($query, $keyword) {
        ...
        if ($request->ajax()) {
            return view('Admin.ManajemenPost.Read', compact('posts'))->render();
        }

        return view('Admin.ManajemenPost.Index', compact('posts'));
    }
