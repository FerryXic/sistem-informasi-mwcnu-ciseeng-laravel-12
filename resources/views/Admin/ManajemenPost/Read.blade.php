...
<!-- Modal Update & Delete -->
@include('Admin.ManajemenPost.Update')
@include('Admin.ManajemenPost.Delete')
...
<script>
  ...
  // Set action form
  document.getElementById('editForm').action = `/admin/manajemen-post/update/${post.id}`;
  document.getElementById('deleteForm').action = `/admin/manajemen-post/destroy/${post.id}`;
