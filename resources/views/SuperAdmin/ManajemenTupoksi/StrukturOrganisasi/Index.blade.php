<x-super-admin.main>
  ...
  <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
    ...
    {{-- Form Tambah --}}
    @include('SuperAdmin.ManajemenTupoksi.StrukturOrganisasi.Create')
              ...
              @foreach($items as $index => $data)
                <tr class="border-b hover:bg-green-50">
                  ...
                  <td class="px-4 py-2 space-x-2">
                    @include('SuperAdmin.ManajemenTupoksi.StrukturOrganisasi.Update')
                    <span class="text-gray-400 italic">-</span>
                    @include('SuperAdmin.ManajemenTupoksi.StrukturOrganisasi.Delete')
                  </td>
                </tr>
              @endforeach
            </tbody>
